...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 185e9c9a-765d-4c33-b2ff-036bf045c472
```

> `185e9c9a-765d-4c33-b2ff-036bf045c472` is the password of the certificate, you can change it to any password you want.

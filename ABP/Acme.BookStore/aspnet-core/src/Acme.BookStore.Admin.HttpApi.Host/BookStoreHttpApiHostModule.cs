    ...
    public class BookStoreHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<BookStoreAdminApplicationContractsModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Acme.BookStore.Admin.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<BookStoreAdminApplicationModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Acme.BookStore.Admin.Application"));
                });
            }
        }
        ...
        private static void ConfigureSwaggerServices(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAbpSwaggerGenWithOAuth(
                ...
                {
                    {"BookStore.Admin", "BookStore  Admin API"}
                },
                options =>
                {
        ...
        {
            var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("BookStore.Admin");
            if (!hostingEnvironment.IsDevelopment())
            {
